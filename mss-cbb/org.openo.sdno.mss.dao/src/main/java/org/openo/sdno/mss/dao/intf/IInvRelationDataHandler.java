 ...
 */
public interface IInvRelationDataHandler {
     ...
     * @param srcUuid source res key id
     * @param dstUuid destination res key id
     * @param srcAttr source attribute
     * @param dstAttr destination attribute
     * @param serviceType service type
     * @param refUnique unique index
     * @return InvRespEntity Object
     * @since SDNO 0.5
     */
    InvRespEntity<List<Map<String, Object>>> get(final String relationType, final String queryType,
