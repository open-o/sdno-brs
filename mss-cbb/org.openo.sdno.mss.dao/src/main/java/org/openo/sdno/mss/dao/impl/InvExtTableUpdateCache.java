 ...
 */
public class InvExtTableUpdateCache {

    private static final Logger LOGGER = LoggerFactory.getLogger(InvExtTableUpdateCache.class);
     ...
     */
    public InvExtTableUpdateCache(SqlSession session, Callable<SqlSession> callable2) {
