 ...
 */
public abstract class AbstractInvDbResultHandler implements ResultHandler {

    private static final Logger LOGGER = LoggerFactory.getLogger(AbstractInvDbResultHandler.class);
