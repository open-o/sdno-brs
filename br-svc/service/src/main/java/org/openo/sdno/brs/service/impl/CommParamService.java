 ...
 */
public class CommParamService implements ICommParamService {

    private static final Logger LOGGER = LoggerFactory.getLogger(CommParamService.class);

    private IResourceService commoperService;

    public IResourceService getCommoperService() {
     ...
     */
    public void setCommoperService(IResourceService commoperService) {
