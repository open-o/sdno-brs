 ...
 */
public class LogicalTPService implements ILogicalTPService {

    private static final Logger LOGGER = LoggerFactory.getLogger(SiteService.class);

    private String resourceTypeName;

    private IResourceService tpOperService;

    private IRelationService tpRelationService;
    ...
    public void setTpOperService(IResourceService tpOperService) {
        this.tpOperService = tpOperService;
    }

    public void setTpRelationService(IRelationService tpRelationService) {
