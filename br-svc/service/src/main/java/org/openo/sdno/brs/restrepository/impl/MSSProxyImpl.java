...
public class MSSProxyImpl implements IMSSProxy {
     ...
     */
    private static final String MSS_SERVICE_REST_URL_PREFIX = "/rest/svc/mss/v2/buckets/";
    ...
    public RestfulResponse getResource(final String bucketName, String resourceTypeName, String objectID)
        ...
        String url =
                new StringBuilder(MSS_SERVICE_REST_URL_PREFIX).append(bucketName).append(FORWARD_SLASH)
                        .append(MSS_REST_URL_RESOURCES).append(FORWARD_SLASH).append(resourceTypeName)
                        .append(FORWARD_SLASH).append(MSS_REST_URL_OBJECT).append(FORWARD_SLASH).append(objectID)
                        .append(Constant.PARAM_SPLIT_LABLE).append(Constant.RESOUCRCE_FILEDS)
                        .append(Constant.EQUIVALENT).append(Constant.FILEDS_ALL).toString();
    ...
    public RestfulResponse getResourceList(final String bucketName, String resourceTypeName, String fields,
        ...
        String url =
                new StringBuilder(MSS_SERVICE_REST_URL_PREFIX).append(bucketName).append(FORWARD_SLASH)
                        .append(MSS_REST_URL_RESOURCES).append(FORWARD_SLASH).append(resourceTypeName)
                        .append(FORWARD_SLASH).append(MSS_REST_URL_OBJECT).append(Constant.PARAM_SPLIT_LABLE)
                        .append(Constant.RESOUCRCE_FILEDS).append(Constant.EQUIVALENT).append(fields)
                        .append(Constant.AND).append("filter").append(Constant.EQUIVALENT).append(filter)
                        .append(Constant.AND).append("pagesize").append(Constant.EQUIVALENT).append(pagesize)
                        .append(Constant.AND).append("pagenum").append(Constant.EQUIVALENT).append(pagenum).toString();
    ...
    public RestfulResponse addResources(final String bucketName, String resourceTypeName, Object obj)
        ...
        String url =
                new StringBuilder(MSS_SERVICE_REST_URL_PREFIX).append(bucketName).append(FORWARD_SLASH)
                        .append(MSS_REST_URL_RESOURCES).append(FORWARD_SLASH).append(resourceTypeName)
                        .append(FORWARD_SLASH).append(MSS_REST_URL_OBJECT).toString();
    ...
    public RestfulResponse
            updateResource(final String bucketName, String resourceTypeName, String objectId, Object obj)
                    throws ServiceException {
        String url =
                new StringBuilder(MSS_SERVICE_REST_URL_PREFIX).append(bucketName).append(FORWARD_SLASH)
                        .append(MSS_REST_URL_RESOURCES).append(FORWARD_SLASH).append(resourceTypeName)
    ...
    public RestfulResponse createRelation(String bucketName, String resourceTypeName, Object obj)
        ...
        String url =
                new StringBuilder(MSS_SERVICE_REST_URL_PREFIX).append(bucketName).append(FORWARD_SLASH)
                        .append(MSS_REST_URL_RESOURCES).append(FORWARD_SLASH).append(resourceTypeName)
                        .append(FORWARD_SLASH).append(MSS_REST_URL_RELATIONSHIPS).toString();
    ...
    public RestfulResponse getRelationResourceList(String bucketName, String resourceTypeName, String fields,
            String filter, int pagesize, int pagenum) throws ServiceException {
        // GET
        // /rest/svc/mss/v2/{bucket-name}/resources/{resource-type-name}/relation-objects?fileds=attr1,attr2******&filter=******=****&pagenum=***&pagesize=****

        String url =
                new StringBuilder(MSS_SERVICE_REST_URL_PREFIX).append(bucketName).append(FORWARD_SLASH)
                        .append(MSS_REST_URL_RESOURCES).append(FORWARD_SLASH).append(resourceTypeName)
                        .append(FORWARD_SLASH).append(MSS_REST_URL_RELATIONOBJECTS).append(Constant.PARAM_SPLIT_LABLE)
                        .append(Constant.RESOUCRCE_FILEDS).append(Constant.EQUIVALENT).append(fields)
                        .append(Constant.AND).append("filter").append(Constant.EQUIVALENT).append(filter)
                        .append(Constant.AND).append("pagesize").append(Constant.EQUIVALENT).append(pagesize)
                        .append(Constant.AND).append("pagenum").append(Constant.EQUIVALENT).append(pagenum).toString();
    ...
    public RestfulResponse checkObjExsit(String bucketName, String resourceTypeName, Object obj)
            throws ServiceException {
        // /rest/svc/mss/v2/buckets/{bucket-name}/resources/{resource-type-name}/checkexist
        String url =
                new StringBuilder(MSS_SERVICE_REST_URL_PREFIX).append(bucketName).append(FORWARD_SLASH)
                        .append(MSS_REST_URL_RESOURCES).append(FORWARD_SLASH).append(resourceTypeName)
                        .append(FORWARD_SLASH).append(MSS_REST_URL_CHECKEXIST).toString();
        return HttpClientUtil.post(url, obj);
    }
    ...
    public RestfulResponse getManageElementByRelation(String bucketName, String siteResTypeName,
        ...
        String url =
                new StringBuilder(MSS_SERVICE_REST_URL_PREFIX).append(bucketName).append(FORWARD_SLASH)
                        .append(MSS_REST_URL_RESOURCES).append(FORWARD_SLASH).append(resourceTypeName)
                        .append(FORWARD_SLASH).append(MSS_REST_URL_RELATIONSHIPS).append(Constant.PARAM_SPLIT_LABLE)
                        .append(MSS_REST_URL_DST_TYPE).append(Constant.EQUIVALENT).append(siteResTypeName)
                        .append(Constant.AND).append(MSS_REST_URL_DST_IDS).append(Constant.EQUIVALENT).append(dstIds)
                        .toString();
    ...
    public RestfulResponse commonQueryCount(String bucketName, String resourceTypeName, String joinAttr, String filter)
            throws ServiceException {
        StringBuffer url =
                new StringBuffer(MSS_SERVICE_REST_URL_PREFIX).append(bucketName).append(FORWARD_SLASH)
                        .append(MSS_REST_URL_RESOURCES).append(FORWARD_SLASH).append(resourceTypeName)
                        .append(FORWARD_SLASH).append(MSS_REST_URL_STATISTICS);
