...
public class SiteService implements ISiteService {
    ...
    private IResWithRelationQueryService siteQueryService;

    private IResourceService siteOperService;
    ...
    public void setSiteQueryService(IResWithRelationQueryService siteQueryService) {
        this.siteQueryService = siteQueryService;
    }

    public void setSiteOperService(IResourceService siteOperService) {
