 ...
 */
public class NetworkControlDomainService implements INetworkControlDomainService {
    ...
    private IResourceService ncdOpreateService;

    private IRelationService meRelationService;

    public IRelationService getMeRelationService() {
        return meRelationService;
    }

    public void setMeRelationService(IRelationService meRelationService) {
    ...
    public IResourceService getNcdOpreateService() {
        return ncdOpreateService;
    }

    public void setNcdOpreateService(IResourceService ncdOpreateService) {
